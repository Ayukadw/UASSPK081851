...
export const OperatorLayout = () => {
  ...
  const menuItems = [
    { key: 'input-data', label: 'Input Data', isActive: location.pathname === '/operator/dashboard', path: '/operator/dashboard' },
    { key: 'kelola-alternatif', label: 'Kelola Alternatif', isActive: location.pathname === '/operator/alternatives', path: '/operator/alternatives' },
  ];
